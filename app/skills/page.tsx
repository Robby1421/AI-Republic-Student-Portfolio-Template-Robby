  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-900 to-purple-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 sm:mb-12 lg:mb-16 text-center sm:text-left">
          SKILLS
        </h1>
        ...
        <div className="space-y-12 sm:space-y-16">
          {skillCategories.map((category, index) => (
            <div key={index} className="space-y-4 sm:space-y-6">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-400 text-center sm:text-left">
                {category.title}
              </h2>
        ...
        <div className="mt-16 sm:mt-20 lg:mt-24 mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 text-center sm:text-left">
            GET IN TOUCH
          </h2>
          ...
          <form
            ...
            className="space-y-4 sm:space-y-6 max-w-3xl mx-auto sm:mx-0"
          >
